...
const OnboardingLayout = () => {
    ...
    return ( 
        <div className='bg-gray-300 p-6 min-h-screen'>
            <section className='max-w-3xl mx-auto  bg-white rounded-xl relative z-10 grid grid-cols-2 gap-4'>
                <div className={`flex flex-col relative z-10 pt-24 items-center gap-5 h-full w-[90%] bg-emerald-500 translate duration-500 p-4 
                     ${transition ? 'translate-x-[129%] rounded-tr-xl rounded-br-xl' : 'translate-x-[0%] rounded-tl-xl rounded-bl-xl'}`}>
